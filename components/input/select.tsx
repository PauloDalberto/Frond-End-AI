import { StyleSheet, TextInput, View, Text, TouchableOpacity, FlatList, Modal } from "react-native";
...
export function Select({ control, name, error, placeholder, options }: SelectProps){
